    ...
    <div class="container-fluid header_top wow bounceIn" data-wow-delay="0.1s">
        <div class="col-sm-10 col-md-10">
            <div class="header_top_left"> <span><i class="fa fa-phone"></i></span> <span>01697 450 200 | 0926 055
                ...
                <span>admin@mylishop.com.vn</span>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 account">
            <div class="row">
                ...
                if (isset($_SESSION['username'])) {
                    ...
                    <span><i class="fa fa-sign-out"></i><a href="users/logout.php"> Đăng xuất </a></span>
                <?php } else {
                    ?>
                    <i class="fa fa-user fa-lg"></i>
                    <a href="users/login.php"> Đăng nhập </a> &nbsp;
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <form role="search" action="search.php" method="POST">
                            ...
                            <div class="cart-total">
                                <a type="submit" class="bg_cart" href="view-cart.php" title="Giỏ hàng">

<?php require_once('../model_test/connect.php'); ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 separator">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="fullname"
                                                placeholder="Nhập họ tên đầy đủ của bạn" required />
                                        </div>
                                    </div><!-- /form-group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span
                                                    class="fa fa-user fa-lg"></span></span>
                                            <input type="text" class="form-control" name="username"
                                                placeholder="Nhập tên đăng ký của bạn" required />
                                        </div>
                                    </div><!-- /form-group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span
                                                    class="fa fa-phone fa-lg"></span></span>
                                            <input type="text"
                                                onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                minlength="9" maxlength="11" class="form-control" name="phone"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span
                                                            class="fa fa-lock fa-lg"></span></span>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control" name="confirmPassword"
                                                        ...
                                                        placeholder="Nhập lại mật khẩu của bạn" tabindex="6" required />
                                                </div><!-- /input-group -->
                                            </div><!-- /form-group -->
                                        </div><!-- /col -->
                                    </div><!-- /row -->
                            ...
                            <div class="row">
                                <div class="btSubmit">
                                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                                        <input type="submit" class="btn btn-info btn-block btn-lg" name="submit"
                                            value="Đăng ký">
                                    </div><!-- /col -->
                                </div><!-- /btnSubmit -->
                            </div><!-- /row -->
